...
return {
	...
	{ "junegunn/fzf", tag = "0.50.0", pin = true, build = "./install --all --xdg" },
	{
		...
		keys = {
			...
			{ "<Leader>ss", function() require("fzf-lua").builtin() end, desc = "Fzf: builtin"},
			-- Files
			...
			-- Buffer lines
			{ "<Leader>sb", function() require("fzf-lua").blines() end, desc = "Fzf: current buffer lines", },
			{ "<Leader>sa", function() require("fzf-lua").lines() end, desc = "Fzf: Lines of all open buffers", },

			-- LSP related (diagnostics)
			{ "<Leader>sd", function() require("fzf-lua").diagnostics_document() end, desc = "Fzf: Document Diagnostics", },
			{ "<Leader>sq", function() require("fzf-lua").quickfix() end, desc = "Fzf: Quickfix", },
			{ "<Leader>sq", function() require("fzf-lua").loclist() end, desc = "Fzf: Loclist", },
			...
			{ "<Leader>sr", function() require("fzf-lua").resume() end, desc = "Fzf: Resume", },
